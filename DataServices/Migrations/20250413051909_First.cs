    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuarterDepartmentRanks", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuarterEmployeeRanks", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "QuarterScoreDepts",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DeptId = table.Column<int>(type: "int", nullable: false),
                    QuarterDeptRankId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuarterScoreDepts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuarterScoreDepts_QuarterDepartmentRanks_QuarterDeptRankId",
                        column: x => x.QuarterDeptRankId,
                        principalTable: "QuarterDepartmentRanks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuarterScoreDepts_QuarterDeptRankId",
                table: "QuarterScoreDepts",
                column: "QuarterDeptRankId");
        }
